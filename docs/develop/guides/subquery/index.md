...
SubQuery is a leading blockchain data indexer that provides developers with fast, flexible, universal, open source and decentralised APIs for web3 projects. SubQuery SDK allows developers to get rich indexed data and build intuitive and immersive decentralised applications in a faster and more efficient way. SubQuery supports 100+ ecosystems including Artela, Ethereum, Polygon, Polkadot, Algorand, NEAR, and Avalanche.
...
- [Artela Testnet Starter Project](https://github.com/subquery/ethereum-subql-starter/tree/main/Artela/artela-testnet-starter)

# Getting Started

Take a look at this SubQuery Starter Project that introduces SubQuery's Artela Testnet support by indexing [Artela Testnet](https://github.com/subquery/ethereum-subql-starter/tree/main/Artela/artela-testnet-starter).
...
# Running and Hosting your Artela Testnet SubQuery APIs
