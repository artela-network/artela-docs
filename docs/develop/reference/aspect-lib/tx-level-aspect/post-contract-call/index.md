...
At [evm.go](https://github.com/artela-network/artela-evm/blob/4f1dd63feab4242118e331f677d4e05c267ea38e/vm/evm.go#L397),
before evm call to create `PostContractCallCtx` ，and execute Join point `PostContractCall`.
...
```javascript
    ...
    aspectRes := djpm.AspectInstance().PostContractCall(txAspect)
